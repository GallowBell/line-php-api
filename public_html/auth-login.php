...
$URL_LOGIN = $APP_URL.$_ENV['LINE_LOGIN_PATH'];
...
<html
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?php echo ASSET_URL('/css/line-btn.css'); ?>" />
          ...
          <div class="card p-2">
            ...
            <div class="app-brand justify-content-center mt-5">
              <a href="index.html" class="app-brand-link gap-2">
                ...
                <span class="app-brand-text demo text-heading fw-semibold">MMT IT-Support</span>
              </a>
            </div>
            <!-- /Logo -->

            <div class="card-body mt-2">
              <h4 class="mb-2">Welcome to MMT IT-Support 👋</h4>
              <p class="mb-4">Please sign-in to your account and start the adventure</p>

              <form id="formAuthentication" class="mb-3" method="get" action="<?php echo htmlspecialchars($URL_LOGIN ); ?>">
                ...
                <div class="mb-3 d-flex justify-content-center">
                  <button class="btn-c btn-line justify-content-center d-grid w-50" type="submit">
                      <span class="border-left ms-3">Login with LINE</span>
                  </button>
                </div>
              </form>
